...
try {
    ...
    $sql =
        'SELECT
            ...
            s.birthday,
            s.address,
            s.certification_image_url,
            s.certification_image_name,
            s.status,
            s.admin_note,
            s.created_at,
            s.reviewed_at,
    ...
    foreach ($stmt->fetchAll() as $row) {
        $rows[] = [
            ...
            'certification_image_url' => (string)($row['certification_image_url'] ?? ''),
            'certification_image_name' => (string)($row['certification_image_name'] ?? ''),
